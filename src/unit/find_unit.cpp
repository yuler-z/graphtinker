...
namespace graphtinker
{
	...
	void UnitFlow::find_unit( margin_t workblock_margin, bucket_t adjvtx_id_hash, workblock_t *workblock, bool is_insert_edge)
	{
...
#ifdef EN_CAL
					unit_option->module_params.cal_localbaseaddrptr = ll_localbaseaddrptr_i;
					unit_option->module_params.cal_localaddrptr = ll_localaddrptr_i;
#endif
					break;
				}
